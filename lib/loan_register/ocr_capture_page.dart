...
/// is previewed; confirming pops the captured image **bytes** (`Uint8List`)
/// back to the caller (collateral step), which stores them for the future OCR
/// API call. Web-compatible: reads the photo as bytes (no `dart:io`) so it
/// works inside the WebView host as well as on mobile.
